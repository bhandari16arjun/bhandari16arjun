<div align="center">
  <h1>Hi there, I'm Arjun Bhandari 👋</h1>
  <h3>Software Engineer | AI & Distributed Systems Architect | Competitive Programmer</h3>
  
  <p>
    I am a B.Tech + M.Tech student at <b>IIIT Gwalior</b>. I specialize in building highly-scalable microservices, distributed systems, and agentic AI pipelines. Passionate about turning complex architectures into production-ready software.
  </p>
...
### 🚀 What I'm Building & My Experience
- 💼 **Software Engineering Intern @ Flickmatch:** Built human-in-the-loop AI chat assistants, automated CI/CD deployment pipelines on AWS Elastic Beanstalk, integrated Amazon SES, and wrote comprehensive E2E tests using Playwright.
- 🧠 **Agentic AI & ML:** Designing autonomous AI systems with **LangGraph**, **LangChain**, and optimizing game-tree search algorithms (NegaMax with Alpha-Beta pruning).
- 🛠️ **Cloud & Distributed Systems:** Orchestrating scalable, Dockerized microservices. Built an Online Code Judge using **MERN**, **Redis (BullMQ)** for asynchronous task queues, and **AWS (EC2, S3)**.

### 💻 Tech Stack
**Languages:** `C`, `C++`, `Python`, `JavaScript`, `TypeScript`, `Java`, `SQL`<br>
**Frameworks:** `React.js`, `Express.js`, `Flask`, `GraphQL`, `Streamlit`, `Playwright`<br>
**Cloud & DBs:** `AWS (EC2, S3, Elastic Beanstalk, SES)`, `Docker`, `Redis`, `BullMQ`, `MongoDB`, `PostgreSQL`<br>
**AI/ML:** `LangGraph`, `LangChain`, `Google Gemini`, `SQLGlot`
...
### 📈 GitHub Stats & Competitive Programming

- ⚔️ **LeetCode Knight** (Max Rating: 1922) | 📊 **Codeforces Specialist** (Max Rating: 1503)
- 🌍 **Global Rank 2031** out of 30,000+ in Codeforces Round 1028 (Div. 2)
